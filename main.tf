/*
TerraForm Template for Alert Logic IDS Appliance deployment in Azure

You must copy the Alert Logic IDS vhd image to a new or existing storage account within the same resource group before running terraform.
